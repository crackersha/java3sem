package prak16.task2;
import java.awt.*;
import java.awt.event.*;
import javax.swing.*;

/* Реализация приложения Java, который имеет макет границы и надписи для каждой области в макете. Теперь определим событиямыши, чтобы.
a. Когда мышь входит в область CENTER программа показывает 142
диалоговое окно с сообщением “Добро пожаловать в ЦАО”
b. Когда мышь входит в область WEST программа показывает диалоговое окно с сообщением “Добро пожаловать в ЗАО”
c. Когда мышь входит в область SOUTH программа показывает диалоговое окно с сообщением “Добро пожаловать ЮАО”
d. Когда мышь входит в область NORTH программа показывает диалоговое окно с сообщением “Добро пожаловать в САО”
e. Когда мышь входит EAST программа показывает диалоговое окно с сообщением “Добро пожаловать в ВАО”*/
